...
def convert_data_to_db(data, compress, per_line=None):
	"""
...
def convert_lists_to_db(data, bpp, per_line=None):
	"""
	...
	for sub_list in data:
		converted_data += (convert_data_to_db(sub_list, bpp, per_line=per_line))
